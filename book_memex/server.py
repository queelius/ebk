"""
Web server for book-memex library management.
...
# Create FastAPI app
app = FastAPI(
    title="book-memex Library Manager",
...
<head>
    ...
    <title>book-memex Library Manager</title>
    <style>
