"""Base exporter class for book-memex library exports."""
...
class BaseExporter(ABC):
    """
    Abstract base class for all book-memex exporters.
    ...
    def load_metadata(self, library_path: Path) -> List[Dict]:
        ...
        Args:
            library_path: Path to the book-memex library
    ...
    def create_readme(self, output_dir: Path, stats: Dict):
        ...
        content = f"""# book-memex Library Export

This directory contains an export of a book-memex library.
