...
def export_hugo(lib_dir, hugo_dir):
    """
    Export book-memex library to Hugo-compatible Markdown files.

    Args:
        lib_dir (str): Path to the book-memex library directory to export (contains `metadata.json` and ebook-related files)
