...
class PluginRegistry:
    ...
    def discover_plugins(self,
                        ...
                        entry_point_group: str = "book_memex.plugins") -> None:
        """
        ...
        for module_info in pkgutil.iter_modules([str(path)]):
            ...
            try:
                ...
                if path.parent in Path(__file__).parents:
                    # It's within the book_memex package
                    module_path = f"book_memex.plugins.{module_info.name}"
                else:
    ...
    def _is_valid_plugin_class(self, obj: Any) -> bool:
        ...
        return (
            ...
            obj.__module__ != 'book_memex.plugins.base'  # Skip base classes
        )
